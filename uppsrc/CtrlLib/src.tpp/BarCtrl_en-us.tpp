...
[s3; &]
[s5;:BarCtrl`:`:WhenHelp: [_^topic`:`/`/Core`/src`/Function`_en`-us`#Upp`:`:Event^ Even
t][@(0.0.255) <const]_[%%_^topic`:`/`/Core`/src`/String`_en`-us`#String`:`:class^ Str
ing][@(0.0.255) `&>]_[* WhenHelp]&]
...
[s3;%% &]
[s4; &]
[s5;:BarCtrl`:`:WhenLeftClick: [_^topic`:`/`/Core`/src`/Function`_en`-us`#Upp`:`:Event^ E
vent]_[* WhenLeftClick]&]
[s2;%% Called when user clicks on bar area.&]
[s3;%% &]
[s4; &]
[s5;:BarCtrl`:`:GetBarCtrlParent`(Ctrl`*`): [@(0.0.255) static] [_^topic`:`/`/CtrlLib`/src`/BarCtrl`_en`-us`#BarCtrl`:`:class^ B
arCtrl]_`*[* GetBarCtrlParent]([_^topic`:`/`/CtrlCore`/src`/Ctrl`_en`-us`#Ctrl`:`:class^ C
trl]_`*[*@3 child])&]
...
ne]([_^topic`:`/`/CtrlCore`/src`/Ctrl`_en`-us`#Ctrl`:`:class^ Ctrl]_`*[*@3 q])&]
...
Line]([_^topic`:`/`/CtrlCore`/src`/Ctrl`_en`-us`#Ctrl`:`:class^ Ctrl]_`*[*@3 q])&]
[s2;%% Sends empty String to the CtrlBar obtained by calling GetBarCtrlParent 
(if any) WhenHelp callback.&]
[s3;%% &]
[s4; &]
[s5;:BarCtrl`:`:Align`(int`): [_^topic`:`/`/CtrlLib`/src`/BarCtrl`_en`-us`#BarCtrl`:`:class^ B
arCtrl][@(0.0.255) `&]_[* Align]([@(0.0.255) int]_[*@3 align])&]
...
[s3;%% &]
[s4; &]
[s5;:BarCtrl`:`:Top`(`): [_^topic`:`/`/CtrlLib`/src`/BarCtrl`_en`-us`#BarCtrl`:`:class^ B
arCtrl][@(0.0.255) `&]_[* Top]()&]
[s2;%% Same as Align(BAR`_TOP).&]
[s3;%% &]
[s4; &]
[s5;:BarCtrl`:`:Bottom`(`): [_^topic`:`/`/CtrlLib`/src`/BarCtrl`_en`-us`#BarCtrl`:`:class^ B
arCtrl][@(0.0.255) `&]_[* Bottom]()&]
[s2;%% Same as Align(BAR`_BOTTOM).&]
[s3;%% &]
[s4; &]
[s5;:BarCtrl`:`:Left`(`): [_^topic`:`/`/CtrlLib`/src`/BarCtrl`_en`-us`#BarCtrl`:`:class^ B
arCtrl][@(0.0.255) `&]_[* Left]()&]
[s2;%% Same as Align(BAR`_LEFT).&]
[s3;%% &]
[s4; &]
[s5;:BarCtrl`:`:Right`(`): [_^topic`:`/`/CtrlLib`/src`/BarCtrl`_en`-us`#BarCtrl`:`:class^ B
arCtrl][@(0.0.255) `&]_[* Right]()&]
...
[s3;%% &]
[s4; &]
[s5;:BarCtrl`:`:Wrap`(int`): [_^topic`:`/`/CtrlLib`/src`/BarCtrl`_en`-us`#BarCtrl`:`:class^ B
arCtrl][@(0.0.255) `&]_[* Wrap]([@(0.0.255) int]_[*@3 q]_`=_[@3 1])&]
...
[s3;%% &]
[s4; &]
[s5;:BarCtrl`:`:NoWrap`(`): [_^topic`:`/`/CtrlLib`/src`/BarCtrl`_en`-us`#BarCtrl`:`:class^ B
arCtrl][@(0.0.255) `&]_[* NoWrap]()&]
[s2;%% Same as Wrap(`-1).&]
[s3;%% &]
[s0; ]]